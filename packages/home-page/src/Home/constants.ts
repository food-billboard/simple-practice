...
export const PACKAGE_MAP = [
  ...
  },
  {
    ...
    image: flappyBird,
    key: 'flagppy-bird',
    // url: internalUrl('flag-getter'),
    code: 'https://github.com/food-billboard/simple-practice/tree/master/packages/flappy-bird'
  },
  {
    label: '新年flag收集小游戏',
    description: '魔改的flappy bird',
    date: '2023-02-12',
    image: flagGetter,
    key: 'flag-getter',
    url: internalUrl('flag-getter'),
    code: 'https://github.com/food-billboard/simple-practice/tree/master/packages/flag-getter'
  },
  {
    label: '2048小游戏',
